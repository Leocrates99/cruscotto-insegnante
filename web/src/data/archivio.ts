...
export interface Fase { id: string; fase: string; modello: string; ordine: number | null; funzione: string; centratura: string; momento: string; perc_monte: number | null; dur_min_60: number | null; dur_max_60: number | null; attivita_docente: string; attivita_studente: string; metodologie_tipiche: string[]; opzionale: boolean }
